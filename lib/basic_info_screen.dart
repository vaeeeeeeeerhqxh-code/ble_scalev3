...
class _BasicInfoScreenState extends State<BasicInfoScreen> {
  ...
  void _showOptions(String title, List<String> options, String current,
                  ...
                  children: [
                    ...
                    _buildMenuCard([
                      _buildRowTile(
                        ...
                        value: _weightUnit,
                        onTap: () => _showOptions(
                            'Единица веса', ['kg', 'lb'], _weightUnit,
                      ...
                      _buildRowTile(
                        ...
                        value: _lengthUnit,
                        onTap: () => _showOptions(
                            'Единица длины', ['cm', 'inch'], _lengthUnit,
